...
main() {
  ...
  local hydrogen_app_path="~/Desktop/Hydrogen.app"
  local roblox_app_path="~/Desktop/Roblox.app"
  ...
  cp "$HOME/hydrogen_unzip/Hydrogen.app/Contents/Resources/libHydrogen.dylib" "~/Desktop/Roblox.app/Contents/MacOS/libHydrogen.dylib"
  cp "~/Desktop/Roblox.app/Contents/MacOS/RobloxPlayer" "~/Desktop/Roblox.app/Contents/MacOS/.RobloxPlayer"

  "$HOME/hydrogen_unzip/Hydrogen.app/Contents/Resources/insert_dylib" --strip-codesig --all-yes "~/Desktop/Roblox.app/Contents/MacOS/libHydrogen.dylib" "~/Desktop/Roblox.app/Contents/MacOS/.RobloxPlayer" "~/Desktop/Roblox.app/Contents/MacOS/RobloxPlayer" >/dev/null 2>&1
